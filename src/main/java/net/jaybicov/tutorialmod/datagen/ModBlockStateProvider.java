package net.jaybicov.tutorialmod.datagen;
...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlockWithRenderType(ModBlocks.ALEXANDRITE_DOOR.get(),
                ...
                "cutout");
        trapdoorBlockWithRenderType(ModBlocks.ALEXANDRITE_TRAPDOOR.get(),
    ...
    // This method makes the blocks we send into both an item and defines that they are square.
    private void blockWithItem(RegistryObject<Block> blockRegistryObject)
    {
        simpleBlockWithItem(blockRegistryObject.get(), cubeAll(blockRegistryObject.get()));
    }

    // The following two methods create a json file for non-blocks.
